{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      bind = $mainMod, S, workspace,󰭹
      bind = $mainMod, T, workspace,󰭹
      bind = $mainMod, W, workspace,󰭹
      bind = $mainMod, M, workspace,
      bind = $mainMod, E, workspace,󰇮
      ...
      #------------------------# 
      bind=$mainMod,B,exec,microsoft-edge --enable-features=UseOzonePlatform --ozone-platform=wayland
      bind=$mainMod,S,exec,slack --enable-features=UseOzonePlatform --ozone-platform=wayland
      bind=$mainMod,T,exec,telegram-desktop
      bind=$mainMod,W,exec,whatsapp-for-linux
      bind=$mainMod,E,exec,evolution
      ...
      windowrule=size 90% 10%,title:quickterm
