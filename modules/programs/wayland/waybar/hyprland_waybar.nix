  ...
  home-manager.users.${user} = {
    ...
    programs.waybar = {
      ...
      style = ''
         ...
         #mode, #clock, #memory, #temperature,#cpu,#mpd, #custom-wall, #temperature, #backlight, #pulseaudio, #network, #battery, #custom-powermenu, #custom-cava-internal, #custom-notifications {
                 padding-left: 10px;
                 padding-right: 10px;
               }
               /* #mode { */
